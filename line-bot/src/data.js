...
/**
 * 晚上的分工，兩邊每天輪。A 是家裡和自己的身體，B 是小孩。
 * 把運動放進 A，等於輪到 A 的人有機會動一動——這是媽媽定的，不要拿掉。
 */
export const EVENING = {
  A: {
    ...
    name: "家裡",
    tasks: [
      { text: "洗碗", note: "碗槽要刷過，洗完的東西歸位，檯面不要積" },
      { text: "整理客廳" },
      { text: "吸整個家地板" },
      { text: "拖地" },
      { text: "運動" },
  ...
  B: {
    ...
    tasks: [
      ...
      { text: "刷牙" },
      { text: "陪睡" },
      { text: "丟垃圾", note: "廚房、尿布桶、兩間廁所、書房，一次收齊" },
    ],
  },
};
...
/**
 * 一次性的設定題：答完就退出每週清單，變成「家規」。
 * 這些是把作息從草稿變成定案要決定的事，不是每週都要重問的。
 */
export const SETUP = [
...
/** 每週日都會問的題目。答案是那一週的，不會蓋掉上週。 */
export const WEEKLY = [
  "週末和下週有沒有特殊行程？學校活動、看診、回老家、加班",
  "上週哪一段沒跑順，要調整嗎？",
  "下週的採買和備餐，有什麼要先準備？",
  "這週誰比較累？下週有沒有要換手的？",
];
